        ...
        return(
            <SafeAreaView style={styles.container}>
              {/* <BlurView intensity={90} tint="dark" style={styles.blurContainer}> */}
                    ...
                    >        
                          <SimpleModal searchPhrase={this.personName} saveImage={this.saveImage} changeModalVisible={this.changeModalVisible}/>
                      </Modal>
    ...
    
                {
                    ...
                    : 
                    (<View>
                        <Image source={{uri:'data:image/jpeg;base64,'+ this.state.imageData}} style={styles.image} />
                        ...
                        <View style={styles.buttons}>
                            ...
                            <TouchableOpacity onPress={async ()=>this.changeModalVisible(true)} style={styles.button}>
                                <Text>
                                    Save ECG    
                                </Text>   
                            </TouchableOpacity>
